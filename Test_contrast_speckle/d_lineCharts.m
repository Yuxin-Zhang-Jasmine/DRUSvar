...
filepath = [pwd '/Test_contrast_speckle/0.0-0.1/sigma1.2/'];
...
% save([pwd '/Test_contrast_speckle/0.0-0.1/metrics.mat'], 'metrics' 'c'); 

%% load the metrics and plot
clc
load([pwd '/Test_contrast_speckle/0.0-0.1/metrics.mat'])
flag_y=1;
type = 1;  fontsize=19;
...
print(gcf,['Test_contrast_speckle/images/gCNR'] ,'-dpdf','-r0')
