...
#SBATCH --job-name=picmusDENOvivo
#SBATCH --qos=short
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=30
#SBATCH --output=picmusDENOvivo.out
#SBATCH --error=picmusDENOvivo.err
#SBATCH --time=60

export CONFIG=/home/yzhang2018@ec-nantes.fr/DRUSvar/DRUSvar/configs/imagenet_256_3c.yml
export MODEL_PATH=vivo
...
python -u /home/yzhang2018@ec-nantes.fr/DRUSvar/DRUSvar/main.py --ni --config $CONFIG  --doc $MODEL_PATH  --ckpt model004000.pt --matlab_path $MATLAB_PATH --deg DENOvivo
