...
#SBATCH --job-name=picmusDRUSvitro
#SBATCH --qos=short
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=30
#SBATCH --output=picmusDRUSvitro.out
#SBATCH --error=picmusDRUSvitro.err
#SBATCH --time=200
...
python -u /home/yzhang2018@ec-nantes.fr/DRUSvar/DRUSvar/main.py --ni --config $CONFIG  --doc $MODEL_PATH  --ckpt model006000.pt --matlab_path $MATLAB_PATH --deg DRUSvitro
