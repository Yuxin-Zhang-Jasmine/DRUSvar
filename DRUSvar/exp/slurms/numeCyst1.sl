...
#SBATCH --job-name=numeCyst1
#SBATCH --qos=short
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=30
#SBATCH --output=numeCyst1.out
#SBATCH --error=numeCyst1.err
#SBATCH --time=200
...
python -u /home/yzhang2018@ec-nantes.fr/DRUSvar/DRUSvar/main.py --ni --config $CONFIG  --doc $MODEL_PATH  --ckpt model004000.pt --matlab_path $MATLAB_PATH --deg NumericalCysts --mIdx 1
