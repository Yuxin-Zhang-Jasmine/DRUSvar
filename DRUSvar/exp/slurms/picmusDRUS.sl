...
#SBATCH --output=picmusDRUS.out
#SBATCH --error=picmusDRUS.err
#SBATCH --time=200
...
python -u /home/yzhang2018@ec-nantes.fr/DRUSvar/DRUSvar/main.py --ni --config $CONFIG  --doc $MODEL_PATH  --ckpt model004000.pt --matlab_path $MATLAB_PATH --deg DRUS
