...
#SBATCH --job-name=numeScatterers1
#SBATCH --qos=short
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=30
#SBATCH --output=numeScatterers1.out
#SBATCH --error=numeScatterers1.err
#SBATCH --time=200

export CONFIG=/home/yzhang2018@ec-nantes.fr/DRUSvar/DRUSvar/configs/imagenet_256_1c.yml
export MODEL_PATH=vitro1c
...
python -u /home/yzhang2018@ec-nantes.fr/DRUSvar/DRUSvar/main.py --ni --config $CONFIG  --doc $MODEL_PATH  --ckpt model004000.pt --matlab_path $MATLAB_PATH --deg NumericalScatterers --mIdx 1
